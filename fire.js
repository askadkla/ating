...
function putValue(canvas, context, ele, dr, callback) {
  ...
  if (ele.innerHTML.indexOf("img") >= 0) {
    ...
    // 获取纯文本内容，去掉HTML标签
    var textContent = ele.textContent || ele.innerText || "";
    // 如果有多个div子元素，将它们连接起来并用换行符分隔
    ...
    context.save();
    // 响应式字体大小
    var fontSize = Math.min(window.innerWidth, window.innerHeight) * 0.08;
